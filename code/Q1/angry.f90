...
program angry_bird
    ...
    open (unit=8 ,file='rk2-0.1.txt',status='unknown')
    write(8,10)
10  format("# time,  posx,  posy,  velx,  vely, anal_y, err_y") 
    write(8,20) time,  posx,  posy,  velx,  vely, anal_y, (anal_y-posy/anal_y)
20  format(E15.3,E15.3,E15.3,E15.3,E15.3,E15.3,E15.3)
    ...
    do while (posy .ge. 0.0)
        ...
        write(8,30) time,  posx,  posy,  velx,  vely, anal_y, (anal_y-posy/anal_y)
30      format(E15.3,E15.3,E15.3,E15.3,E15.3,E15.3,E15.3)
    end do
